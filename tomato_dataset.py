...
class TomatoDataModule(LightningDataModule):
    ...
    def __init__(self,
                ...
                pred_transforms=get_valid_transforms(target_img_size=512),
...
def get_dm(name="d801010", data_file="test", batch_size=BATCH_SIZE):
    ...
    para crear el dataset de predicción.
    """
...
def get_main_df(path=main_ds):
    """
    Lee anotaciones de un .csv "maestro" con las anotaciones para todas las imágenes.
    """
    dataset_path = Path(path)
