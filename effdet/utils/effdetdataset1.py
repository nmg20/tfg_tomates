...
def get_dm(train,val,test,batch_size):
...
# def get_dm_standalone(path=main_ds,name="d801010", data_file="test", batch_size=BATCH_SIZE):
#     """
...
def get_dm_standalone(name="d801010", batch_size=BATCH_SIZE):
    """
    Carga primero los Datasets con anotaciones y luego lee las imágenes de una carpeta
    para crear el dataset para predecir.
    """
    train, test, val = load_dss(name)
